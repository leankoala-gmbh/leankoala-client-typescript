import {ICreateArguments, IUpdateArguments} from '../../../Repository/Entities/AlertingChannelRepository'
...
export interface IRAlertingChannel {
  ...
  create(project: string, args: ICreateArguments): Promise<IRAlertResponseCreate>
  delete(project: string, channel: number, args?: object): Promise<void>
  update(project: string, channel: number, args: IUpdateArguments): Promise<IAlertResponseUpdate>
}
