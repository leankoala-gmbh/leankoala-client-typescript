...
var LeankoalaClient = class {
  ...
  connect(args) {
    return __async(this, null, function* () {
      ...
      try {
        this._repositoryCollection = new RepositoryCollection_default();
        result = yield this._initConnection(__spreadProps(__spreadValues({}, args), { axios: axios2 }));
      } catch (error) {
        this._connectionStatus = "disconnected";
        throw error;
      }
...
export {
  BadRequestError_default as BadRequestError,
  LeankoalaClient,
  Marketplace_default as MarketPlaceConsts,
  RefreshTokenInvalidError_default as RefreshTokenInvalidError,
  SessionConnector_default as SessionConnector
};
//# sourceMappingURL=360ApiClient.esm.js.map
